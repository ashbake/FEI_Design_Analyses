...
dlam    = 0.14     # [um]      wavelength coverage on CRED2 (assume 1.475 - 1.70 um)       
#dlam =  lam0/100000 # for spectral resolution element
T       = 0.25      # [e-/ph]   Throughput to CRED2 (including QE) -- assuming PyPO out but vortex IN
FWHM    = 3.5         # [px]      FWHM of PSF
H_mag   = 9         # []        H-band magnitude to assume for star
DC      = 0.01     # [e-/s/px] dark current (CRED2 spec)
RN      = 12        # [e-/px]   read noise (CRED2 spec)
texp    = 0.1
FPS     = 1/texp   # [Hz]      frame rate to assume for CRED2 (sets itime as 1/FPS)
e_max   = 50000      # [e-]      well-depth for CRED2 (CRED2 spec for high gain mode
