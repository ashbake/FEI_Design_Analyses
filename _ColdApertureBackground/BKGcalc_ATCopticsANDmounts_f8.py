...
def lens_thermal_calc(ploton=False):
    ...
    temp = 277 * u.K # temperature assumed for all optics
    ...
    silica_emissivity = load_window_emissivity(wave)
    ...
    for i,name in enumerate(names):        
        ...
        thermal_spectrum = QE * silica_emissivity * mitsuko_blocking_filter * bb_spec_dens 
...
def mount_thermal_calc(ploton=False):
    ...
    f_nums_lens = [8.1, 9.9] # lens 1 made big enough to not matter
    f_nums_mount  = [8,9.4]
